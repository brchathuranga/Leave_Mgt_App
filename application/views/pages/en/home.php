<h1>Collins Aerospace Leave and Overtime Management System</h1>

<p>Welcome to Collins Aerospace leave management system. Feel free to click on the online help icon for each screen (<i class="mdi mdi-help-circle-outline"></i>).
