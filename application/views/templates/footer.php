    ...
    <div class="row" id="footer">
        ...
        <div class="span4 pull-right">
              <?php switch ($language_code){
                  case 'fr' : echo '<a class="anchor" href="http://mycollins.utc.com/" target="_blank">Collins Aerospace</a>'; break;
                  default : echo '<a class="anchor" href="http://mycollins.utc.com/" target="_blank">Collins Aerospace</a>'; break;
              } ?>
