...
<div class="row vertical-center">
    ...
    <div class="span6 form-box">
        <div class="row-fluid">
            <div class="span6" style="height:100%;margin-top:20px;">
                <div class="row-fluid">
                    <center>
                        <div class="span12">
                            <img src="<?php echo base_url();?>assets/images/logo_simple_new.png">
                        </div>
                    </center>
                </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
                        <span style="font-size: 180%; font-weight: bold; line-height: 130%;">
                            <center><?php echo ('Collins <br> Leave Management System');?></center>
                        </span>
                    </div>
